...
import com.crossover.medicalconference.Fragments.FragmentInvites;
import com.crossover.medicalconference.Fragments.FragmentProfile;
import com.crossover.medicalconference.Fragments.FragmentSendTopics;
...
public class DoctorMain extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.invites_viewer) {
            fr = new FragmentInvites();
        } else if (id == R.id.profile) {
            fr = new FragmentProfile();
        } else if (id == R.id.view_topics) {
            fr = new FragmentTopics();
        } else if (id == R.id.send_topic) {
            fr = new FragmentSendTopics();
